...
* VHDL
  * [GHDL](https://github.com/ghdl/ghdl) ⭐ 2,871 | 🐛 343 | 🌐 VHDL | 📅 2026-08-29 - VHDL compiler and simulator, IEEE 1076-2002, written in ADA
  * [nvc](https://github.com/nickg/nvc) ⭐ 878 | 🐛 107 | 🌐 C | 📅 2026-08-29 - GPLv3 VHDL compiler and simulator, IEEE 1076-2002, written in C
* chisel/firrtl
...
* VHDL
  * [Open Logic](https://github.com/open-logic/open-logic) ⭐ 1,009 | 🐛 15 | 🌐 VHDL | 📅 2026-08-25 - VHDL Standard Library (FIFOs, CDCs, fixed-point math, etc.)
* System Verilog
  * [Taxi Transport Library](https://github.com/fpganinja/taxi) ⭐ 915 | 🐛 25 | 🌐 SystemVerilog | 📅 2026-08-28 - System Verilog standard library
...
* Dart
  * [ROHD](https://github.com/intel/rohd) ⭐ 488 | 🐛 139 | 🌐 Dart | 📅 2026-08-25 - A framework for hardware description and verification, 2021+

* Haskell
  * [CλaSH](https://github.com/clash-lang/clash-compiler) ⭐ 1,609 | 🐛 403 | 🌐 Haskell | 📅 2026-08-31 - A functional hardware description language
  * [Bluespec](https://github.com/B-Lang-org/bsc) ⭐ 1,142 | 🐛 338 | 🌐 Haskell | 📅 2026-08-24 - Compiler, simulator, and tools for the Bluespec Hardware Description Language.
  * [sv2v](https://github.com/zachjs/sv2v) ⭐ 749 | 🐛 39 | 🌐 Haskell | 📅 2026-08-18 - SystemVerilog to Verilog conversion
...
* JavaScript
  ...
  * [shdl](https://github.com/jcbuisson/shdl) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-30 - Simple Hardware Description Language
...
* OCaml
  * [Hardcaml](https://github.com/janestreet/hardcaml/blob/master/docs/index.mdx) ⭐ 1,121 | 🐛 7 | 🌐 OCaml | 📅 2026-07-10 An OCaml library for designing hardware, complete with testing and simulation tools.

* Kotlin
  * [Verik](https://github.com/frwang96/verik) ⭐ 47 | 🐛 0 | 🌐 Kotlin | 📅 2022-12-24 HDL for design and verification. generates SV. UVM.

* Python
  * [Amaranth](https://github.com/amaranth-lang/amaranth) ⭐ 2,075 | 🐛 130 | 🌐 Python | 📅 2026-08-23 (previously nMigen) - A refreshed Python toolbox for building complex digital hardware, 2018+
  * [migen](https://github.com/m-labs/migen) ⚠️ Archived - Meta HDL, 2011+
  * [MyHDL](https://github.com/myhdl/myhdl) ⭐ 1,127 | 🐛 131 | 🌐 Python | 📅 2025-04-10 - Process based HDL, verification framework included, 2004+
...
* Rust
  * [calyx](https://github.com/cucapra/calyx) ⭐ 612 | 🐛 178 | 🌐 Rust | 📅 2026-08-19 - Intermediate Language (IL) for Hardware Accelerator Generators, 2020+
...
* Scala
  * [chisel](https://github.com/freechipsproject/chisel3) ⭐ 4,768 | 🐛 510 | 🌐 Scala | 📅 2026-08-28 - Meta HDL, 2012+
  * [SpinalHDL](https://github.com/SpinalHDL/SpinalHDL) ⭐ 2,031 | 🐛 173 | 🌐 Scala | 📅 2026-08-12 - Meta HDL 2012+
...
* Veryl
  * [Veryl](https://github.com/dalance/veryl) ⭐ 1,027 | 🐛 141 | 🌐 Rust | 📅 2026-08-31 - An original HDL based on SystemVerilog / Rust syntax, and transplier to SystemVerilog
...
* [Holoso](https://github.com/Zubax/holoso) ⭐ 34 | 🐛 7 | 🌐 Python | 📅 2026-08-27 - 2026+, high-level synthesis of portable Verilog from idiomatic Python for numerical/DSP applications
...
* [Silice](https://github.com/sylefeb/Silice) ⭐ 1,430 | 🐛 71 | 🌐 C++ | 📅 2026-08-23 - A language for hardcoding algorithms into FPGA hardware
* [act](https://github.com/asyncvlsi/act) ⭐ 130 | 🐛 1 | 🌐 C++ | 📅 2026-08-30 - asynchronous circuit/compiler tools
* [ORD](https://github.com/tub-msc/ordec) ⭐ 115 | 🐛 5 | 🌐 Python | 📅 2026-08-31 - Python-superset HDL for analog and mixed-signal IC design entry, part of the open-source ORDeC design platform
* [autopiper](https://github.com/google/autopiper) ⚠️ Archived
* [AnvilHDL](https://github.com/kisp-nus/anvil) ⭐ 33 | 🐛 29 | 🌐 OCaml | 📅 2026-08-05 - 2025+, An HDL designed to help avoid common bugs while allowing low-level control through a Rust-like type system
...
* [lgraph](https://github.com/masc-ucsc/lgraph) ⭐ 240 | 🐛 3 | 🌐 C++ | 📅 2026-08-31 - 2017-?, A Multi-Language Synthesis and Simulation IR for Hardware Design
...
* [yosys](https://github.com/YosysHQ/yosys) ⭐ 4,721 | 🐛 560 | 🌐 C++ | 📅 2026-08-31 - RTL synthesis framework
* [vtr-verilog-to-routing](https://github.com/verilog-to-routing/vtr-verilog-to-routing) ⭐ 1,260 | 🐛 128 | 🌐 C++ | 📅 2026-08-31

## Visualization and Documentation generators

* [wavedrom](https://github.com/drom/wavedrom) ⭐ 3,477 | 🐛 204 | 🌐 JavaScript | 📅 2026-08-31 - Javascript wave graph visualizer for documentations and sim.
* [netlistsvg](https://github.com/nturley/netlistsvg) ⭐ 822 | 🐛 55 | 🌐 JavaScript | 📅 2024-01-25 - Javascript schematic visualizer
...
* [slang](https://github.com/MikePopoloski/slang) ⭐ 1,124 | 🐛 24 | 🌐 C++ | 📅 2026-08-31 - SystemVerilog compiler and language service.
...
* [rust\_hdl](https://github.com/kraigher/rust_hdl) ⭐ 505 | 🐛 88 | 🌐 Rust | 📅 2026-08-29 - VHDL parser and language server written in Rust
* [sv-parser](https://github.com/dalance/sv-parser) ⭐ 482 | 🐛 40 | 🌐 Rust | 📅 2026-06-10 -  IEEE 1800-2017 System Verilog Parser written in Rust
* [Surelog](https://github.com/chipsalliance/Surelog) ⭐ 473 | 🐛 47 | 🌐 C++ | 📅 2026-08-31 - SystemVerilog 2017 Pre-processor, Parser, Elaborator, UHDM Compiler. Provides IEEE Design/TB C/C++ VPI and Python AST API.
...
* [cocotb](https://github.com/potentialventures/cocotb) ⭐ 2,486 | 🐛 412 | 🌐 Python | 📅 2026-08-31 - A coroutine based co-simulation library for writing VHDL and Verilog testbenches in Python
...
* [osvvm](https://github.com/OSVVM/OsvvmLibraries) ⭐ 87 | 🐛 4 | 📅 2026-08-30 -  A VHDL verification framework, verification utility library, verification component library, and a simulator independent scripting flow
* [uvvm](https://github.com/OSVVM/OsvvmLibraries) ⭐ 87 | 🐛 4 | 📅 2026-08-30 - A free and Open Source Methodology and Library for VHDL verification of FPGA and ASIC.
...
* [fusesoc](https://github.com/olofk/fusesoc) ⭐ 1,453 | 🐛 153 | 🌐 Python | 📅 2026-08-24 -  Package manager and a set of build tools for HDL.
...
* [svlint](https://github.com/dalance/svlint) ⭐ 391 | 🐛 24 | 🌐 Rust | 📅 2025-11-06 - SystemVerilog linter compliant with IEEE1800-2017. Written in Rust, based on [sv-parser](https://github.com/dalance/sv-parser) ⭐ 482 | 🐛 40 | 🌐 Rust | 📅 2026-06-10.
* [bender](https://github.com/pulp-platform/bender) ⭐ 389 | 🐛 52 | 🌐 Rust | 📅 2026-08-20 -  Dependency management tool for hardware design projects.
* [peakrdl](https://github.com/SystemRDL/PeakRDL) ⭐ 210 | 🐛 7 | 🌐 Python | 📅 2026-07-14 - CSR toolchain to generate RTL, UVM RAL models, document(html and markdown), IPXACT, c header from SystemRDL or IPXACT.
* [HDLGen](https://github.com/WilsonChen003/HDLGen) ⭐ 115 | 🐛 0 | 🌐 Verilog | 📅 2023-10-31 - Tool for processing of embedded Perl or Python scripts in Verilog source code.
