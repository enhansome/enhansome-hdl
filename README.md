...
* VHDL
  * [GHDL](https://github.com/ghdl/ghdl) ⭐ 2,893 | 🐛 336 | 🌐 VHDL | 📅 2026-09-14 - VHDL compiler and simulator, IEEE 1076-2002, written in ADA
  * [nvc](https://github.com/nickg/nvc) ⭐ 879 | 🐛 105 | 🌐 C | 📅 2026-09-15 - GPLv3 VHDL compiler and simulator, IEEE 1076-2002, written in C
* chisel/firrtl
...
* VHDL
  * [Open Logic](https://github.com/open-logic/open-logic) ⭐ 1,011 | 🐛 17 | 🌐 VHDL | 📅 2026-09-11 - VHDL Standard Library (FIFOs, CDCs, fixed-point math, etc.)
* System Verilog
  * [Taxi Transport Library](https://github.com/fpganinja/taxi) ⭐ 935 | 🐛 31 | 🌐 SystemVerilog | 📅 2026-08-28 - System Verilog standard library
...
* Dart
  * [ROHD](https://github.com/intel/rohd) ⭐ 489 | 🐛 141 | 🌐 Dart | 📅 2026-09-14 - A framework for hardware description and verification, 2021+

* Haskell
  * [CλaSH](https://github.com/clash-lang/clash-compiler) ⭐ 1,614 | 🐛 405 | 🌐 Haskell | 📅 2026-09-15 - A functional hardware description language
  * [Bluespec](https://github.com/B-Lang-org/bsc) ⭐ 1,144 | 🐛 352 | 🌐 Haskell | 📅 2026-09-02 - Compiler, simulator, and tools for the Bluespec Hardware Description Language.
  * [sv2v](https://github.com/zachjs/sv2v) ⭐ 751 | 🐛 39 | 🌐 Haskell | 📅 2026-08-18 - SystemVerilog to Verilog conversion
  * [concat](https://github.com/conal/concat) ⭐ 459 | 🐛 38 | 🌐 Haskell | 📅 2024-02-28 Haskell to hardware, 2016+
...
* JavaScript
  ...
  * [shdl](https://github.com/jcbuisson/shdl) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-15 - Simple Hardware Description Language
...
* OCaml
  * [Hardcaml](https://github.com/janestreet/hardcaml/blob/master/docs/index.mdx) ⭐ 1,131 | 🐛 7 | 🌐 OCaml | 📅 2026-07-10 An OCaml library for designing hardware, complete with testing and simulation tools.

* Kotlin
  * [Verik](https://github.com/frwang96/verik) ⭐ 47 | 🐛 0 | 🌐 Kotlin | 📅 2022-12-24 HDL for design and verification. generates SV. UVM.

* Python
  * [Amaranth](https://github.com/amaranth-lang/amaranth) ⭐ 2,085 | 🐛 132 | 🌐 Python | 📅 2026-09-10 (previously nMigen) - A refreshed Python toolbox for building complex digital hardware, 2018+
  * [migen](https://github.com/m-labs/migen) ⚠️ Archived - Meta HDL, 2011+
  * [MyHDL](https://github.com/myhdl/myhdl) ⭐ 1,129 | 🐛 132 | 🌐 Python | 📅 2026-09-14 - Process based HDL, verification framework included, 2004+
  ...
  * [PyRTL](https://github.com/UCSBarchlab/PyRTL) ⭐ 302 | 🐛 20 | 🌐 Python | 📅 2026-08-13 - Meta HDL, simulator suitable for research.
  ...
  * [HWT](https://github.com/Nic30/hwt) ⭐ 226 | 🐛 11 | 🌐 Python | 📅 2026-08-25 Meta HDL, verification env. IP-core generator, analysis tools, HDL glue
  * [garnet](https://github.com/StanfordAHA/garnet) ⭐ 119 | 🐛 79 | 🌐 Python | 📅 2026-08-26 Coarse-Grained Reconfigurable Architecture generator based on magma, 2018+
  ...
  * [GateForge](https://github.com/vagran/GateForge) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2025-04-06 - Meta HDL, 2025+
...
* Rust
  * [calyx](https://github.com/cucapra/calyx) ⭐ 614 | 🐛 178 | 🌐 Rust | 📅 2026-09-14 - Intermediate Language (IL) for Hardware Accelerator Generators, 2020+
  * [kaze](https://github.com/yupferris/kaze) ⚠️ Archived - Meta HDL, 2019+
  * [hoodlum](https://github.com/tcr/hoodlum) ⭐ 99 | 🐛 16 | 🌐 Rust | 📅 2017-04-08 - Meta HDL, 2016+
  * [Cement](https://github.com/pku-liang/Cement) ⭐ 41 | 🐛 0 | 🌐 Rust | 📅 2025-01-16 - A rule-based Meta HDL inspired by Bluespec, 2024+
...
* Scala
  * [chisel](https://github.com/freechipsproject/chisel3) ⭐ 4,785 | 🐛 510 | 🌐 Scala | 📅 2026-09-11 - Meta HDL, 2012+
  * [SpinalHDL](https://github.com/SpinalHDL/SpinalHDL) ⭐ 2,039 | 🐛 174 | 🌐 Scala | 📅 2026-09-13 - Meta HDL 2012+
...
* Veryl
  * [Veryl](https://github.com/dalance/veryl) ⭐ 1,036 | 🐛 145 | 🌐 Rust | 📅 2026-09-15 - An original HDL based on SystemVerilog / Rust syntax, and transplier to SystemVerilog

## HLS

* [Vitis](https://github.com/Xilinx/HLS) ⭐ 415 | 🐛 10 | 📅 2026-08-04 - LLVM based, made by Xilinx. [user manual](https://www.xilinx.com/support/documentation/sw_manuals/xilinx2020_2/ug1399-vitis-hls.pdf)
...
* [Holoso](https://github.com/Zubax/holoso) ⭐ 36 | 🐛 9 | 🌐 Python | 📅 2026-09-15 - 2026+, high-level synthesis of portable Verilog from idiomatic Python for numerical/DSP applications
...
* [Silice](https://github.com/sylefeb/Silice) ⭐ 1,430 | 🐛 70 | 🌐 C++ | 📅 2026-09-10 - A language for hardcoding algorithms into FPGA hardware
* [act](https://github.com/asyncvlsi/act) ⭐ 130 | 🐛 2 | 🌐 C++ | 📅 2026-09-13 - asynchronous circuit/compiler tools
* [ORD](https://github.com/tub-msc/ordec) ⭐ 123 | 🐛 8 | 🌐 Python | 📅 2026-09-15 - Python-superset HDL for analog and mixed-signal IC design entry, part of the open-source ORDeC design platform
* [autopiper](https://github.com/google/autopiper) ⚠️ Archived
* [AnvilHDL](https://github.com/kisp-nus/anvil) ⭐ 35 | 🐛 28 | 🌐 OCaml | 📅 2026-09-12 - 2025+, An HDL designed to help avoid common bugs while allowing low-level control through a Rust-like type system
...
* [lgraph](https://github.com/masc-ucsc/lgraph) ⭐ 241 | 🐛 5 | 🌐 C++ | 📅 2026-09-15 - 2017-?, A Multi-Language Synthesis and Simulation IR for Hardware Design
...
* [yosys](https://github.com/YosysHQ/yosys) ⭐ 4,755 | 🐛 545 | 🌐 C++ | 📅 2026-09-15 - RTL synthesis framework
* [vtr-verilog-to-routing](https://github.com/verilog-to-routing/vtr-verilog-to-routing) ⭐ 1,266 | 🐛 129 | 🌐 C++ | 📅 2026-09-15

## Visualization and Documentation generators

* [wavedrom](https://github.com/drom/wavedrom) ⭐ 3,493 | 🐛 205 | 🌐 JavaScript | 📅 2026-08-31 - Javascript wave graph visualizer for documentations and sim.
* [netlistsvg](https://github.com/nturley/netlistsvg) ⭐ 828 | 🐛 55 | 🌐 JavaScript | 📅 2024-01-25 - Javascript schematic visualizer
* [bitfield](https://github.com/drom/bitfield) ⭐ 394 | 🐛 19 | 🌐 JavaScript | 📅 2024-02-22 - Javascript bit field diagram renderer
* [d3-hwschematic](https://github.com/Nic30/d3-hwschematic) ⭐ 123 | 🐛 20 | 🌐 JavaScript | 📅 2026-05-13 - Javascript hierarchical schematic visualizer for HDLs
...
* [slang](https://github.com/MikePopoloski/slang) ⭐ 1,140 | 🐛 20 | 🌐 C++ | 📅 2026-09-15 - SystemVerilog compiler and language service.
* [pyverilog](https://github.com/PyHDI/Pyverilog) ⭐ 801 | 🐛 82 | 🌐 Python | 📅 2024-06-15 - Python-based Hardware Design Processing Toolkit for Verilog HDL
* [rust\_hdl](https://github.com/kraigher/rust_hdl) ⭐ 509 | 🐛 88 | 🌐 Rust | 📅 2026-09-15 - VHDL parser and language server written in Rust
* [sv-parser](https://github.com/dalance/sv-parser) ⭐ 482 | 🐛 40 | 🌐 Rust | 📅 2026-06-10 -  IEEE 1800-2017 System Verilog Parser written in Rust
* [Surelog](https://github.com/chipsalliance/Surelog) ⭐ 475 | 🐛 47 | 🌐 C++ | 📅 2026-09-15 - SystemVerilog 2017 Pre-processor, Parser, Elaborator, UHDM Compiler. Provides IEEE Design/TB C/C++ VPI and Python AST API.
* [hdlConvertor](https://github.com/Nic30/hdlConvertor) ⭐ 332 | 🐛 32 | 🌐 C++ | 📅 2025-06-30 - Fast (System) Verilog/VHDL parser written as C++ extension for Python
...
* [cocotb](https://github.com/potentialventures/cocotb) ⭐ 2,503 | 🐛 417 | 🌐 Python | 📅 2026-09-14 - A coroutine based co-simulation library for writing VHDL and Verilog testbenches in Python
...
* [osvvm](https://github.com/OSVVM/OsvvmLibraries) ⭐ 88 | 🐛 5 | 📅 2026-09-10 -  A VHDL verification framework, verification utility library, verification component library, and a simulator independent scripting flow
* [uvvm](https://github.com/OSVVM/OsvvmLibraries) ⭐ 88 | 🐛 5 | 📅 2026-09-10 - A free and Open Source Methodology and Library for VHDL verification of FPGA and ASIC.
...
* [fusesoc](https://github.com/olofk/fusesoc) ⭐ 1,457 | 🐛 150 | 🌐 Python | 📅 2026-09-12 -  Package manager and a set of build tools for HDL.
* [RgGen](https://github.com/rggen/rggen) ⭐ 469 | 🐛 23 | 🌐 Ruby | 📅 2026-09-11 - Code generator tool to generate RTL, UVM RAL models and Wiki documents from CSR specifications
* [bender](https://github.com/pulp-platform/bender) ⭐ 393 | 🐛 41 | 🌐 Rust | 📅 2026-09-15 -  Dependency management tool for hardware design projects.
* [svlint](https://github.com/dalance/svlint) ⭐ 393 | 🐛 24 | 🌐 Rust | 📅 2025-11-06 - SystemVerilog linter compliant with IEEE1800-2017. Written in Rust, based on [sv-parser](https://github.com/dalance/sv-parser) ⭐ 482 | 🐛 40 | 🌐 Rust | 📅 2026-06-10.
* [peakrdl](https://github.com/SystemRDL/PeakRDL) ⭐ 211 | 🐛 6 | 🌐 Python | 📅 2026-09-01 - CSR toolchain to generate RTL, UVM RAL models, document(html and markdown), IPXACT, c header from SystemRDL or IPXACT.
