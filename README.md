...
* VHDL
  * [GHDL](https://github.com/ghdl/ghdl) ⭐ 2,867 | 🐛 347 | 🌐 VHDL | 📅 2026-08-24 - VHDL compiler and simulator, IEEE 1076-2002, written in ADA
...
* Dart
  * [ROHD](https://github.com/intel/rohd) ⭐ 488 | 🐛 138 | 🌐 Dart | 📅 2026-08-19 - A framework for hardware description and verification, 2021+
...
* OCaml
  * [Hardcaml](https://github.com/janestreet/hardcaml/blob/master/docs/index.mdx) ⭐ 1,117 | 🐛 7 | 🌐 OCaml | 📅 2026-07-10 An OCaml library for designing hardware, complete with testing and simulation tools.
...
* Python
  ...
  * [HWT](https://github.com/Nic30/hwt) ⭐ 226 | 🐛 11 | 🌐 Python | 📅 2026-08-24 Meta HDL, verification env. IP-core generator, analysis tools, HDL glue
  * [garnet](https://github.com/StanfordAHA/garnet) ⭐ 119 | 🐛 79 | 🌐 Python | 📅 2026-08-22 Coarse-Grained Reconfigurable Architecture generator based on magma, 2018+
...
* Rust
  * [calyx](https://github.com/cucapra/calyx) ⭐ 611 | 🐛 174 | 🌐 Rust | 📅 2026-08-19 - Intermediate Language (IL) for Hardware Accelerator Generators, 2020+
...
* Scala
  * [chisel](https://github.com/freechipsproject/chisel3) ⭐ 4,762 | 🐛 512 | 🌐 Scala | 📅 2026-08-23 - Meta HDL, 2012+
  * [SpinalHDL](https://github.com/SpinalHDL/SpinalHDL) ⭐ 2,031 | 🐛 168 | 🌐 Scala | 📅 2026-08-12 - Meta HDL 2012+
...
* Veryl
  * [Veryl](https://github.com/dalance/veryl) ⭐ 1,024 | 🐛 145 | 🌐 Rust | 📅 2026-08-24 - An original HDL based on SystemVerilog / Rust syntax, and transplier to SystemVerilog
...
* [lgraph](https://github.com/masc-ucsc/lgraph) ⭐ 239 | 🐛 3 | 🌐 C++ | 📅 2026-08-24 - 2017-?, A Multi-Language Synthesis and Simulation IR for Hardware Design
...
* [vtr-verilog-to-routing](https://github.com/verilog-to-routing/vtr-verilog-to-routing) ⭐ 1,257 | 🐛 126 | 🌐 C++ | 📅 2026-08-24
...
* [slang](https://github.com/MikePopoloski/slang) ⭐ 1,120 | 🐛 24 | 🌐 C++ | 📅 2026-08-21 - SystemVerilog compiler and language service.
...
* [Surelog](https://github.com/chipsalliance/Surelog) ⭐ 472 | 🐛 47 | 🌐 C++ | 📅 2026-08-24 - SystemVerilog 2017 Pre-processor, Parser, Elaborator, UHDM Compiler. Provides IEEE Design/TB C/C++ VPI and Python AST API.
...
* [cocotb](https://github.com/potentialventures/cocotb) ⭐ 2,483 | 🐛 412 | 🌐 Python | 📅 2026-08-24 - A coroutine based co-simulation library for writing VHDL and Verilog testbenches in Python
...
* [svlint](https://github.com/dalance/svlint) ⭐ 389 | 🐛 24 | 🌐 Rust | 📅 2025-11-06 - SystemVerilog linter compliant with IEEE1800-2017. Written in Rust, based on [sv-parser](https://github.com/dalance/sv-parser) ⭐ 481 | 🐛 40 | 🌐 Rust | 📅 2026-06-10.
