...
* VHDL
  * [GHDL](https://github.com/ghdl/ghdl) ⭐ 2,898 | 🐛 337 | 🌐 VHDL | 📅 2026-09-20 - VHDL compiler and simulator, IEEE 1076-2002, written in ADA
  * [nvc](https://github.com/nickg/nvc) ⭐ 882 | 🐛 107 | 🌐 C | 📅 2026-09-23 - GPLv3 VHDL compiler and simulator, IEEE 1076-2002, written in C
* chisel/firrtl
...
* VHDL
  * [Open Logic](https://github.com/open-logic/open-logic) ⭐ 1,014 | 🐛 14 | 🌐 VHDL | 📅 2026-09-24 - VHDL Standard Library (FIFOs, CDCs, fixed-point math, etc.)
* System Verilog
  * [Taxi Transport Library](https://github.com/fpganinja/taxi) ⭐ 950 | 🐛 31 | 🌐 SystemVerilog | 📅 2026-08-28 - System Verilog standard library
...
* Dart
  * [ROHD](https://github.com/intel/rohd) ⭐ 489 | 🐛 148 | 🌐 Dart | 📅 2026-09-23 - A framework for hardware description and verification, 2021+

* Haskell
  * [CλaSH](https://github.com/clash-lang/clash-compiler) ⭐ 1,618 | 🐛 403 | 🌐 Haskell | 📅 2026-09-24 - A functional hardware description language
  * [Bluespec](https://github.com/B-Lang-org/bsc) ⭐ 1,142 | 🐛 349 | 🌐 Haskell | 📅 2026-09-22 - Compiler, simulator, and tools for the Bluespec Hardware Description Language.
...
* JavaScript
  * [hdl-js](https://github.com/DmitrySoshnikov/hdl-js) ⭐ 90 | 🐛 6 | 🌐 JavaScript | 📅 2018-10-09 - Hardware description language (HDL) parser, and Hardware simulator.
...
* OCaml
  * [Hardcaml](https://github.com/janestreet/hardcaml/blob/master/docs/index.mdx) ⭐ 1,136 | 🐛 7 | 🌐 OCaml | 📅 2026-07-10 An OCaml library for designing hardware, complete with testing and simulation tools.

* Kotlin
  * [Verik](https://github.com/frwang96/verik) ⭐ 47 | 🐛 0 | 🌐 Kotlin | 📅 2022-12-24 HDL for design and verification. generates SV. UVM.

* Python
  * [Amaranth](https://github.com/amaranth-lang/amaranth) ⭐ 2,093 | 🐛 131 | 🌐 Python | 📅 2026-09-18 (previously nMigen) - A refreshed Python toolbox for building complex digital hardware, 2018+
  ...
  * [PyRTL](https://github.com/UCSBarchlab/PyRTL) ⭐ 305 | 🐛 21 | 🌐 Python | 📅 2026-08-13 - Meta HDL, simulator suitable for research.
...
* Rust
  * [calyx](https://github.com/cucapra/calyx) ⭐ 615 | 🐛 178 | 🌐 Rust | 📅 2026-09-24 - Intermediate Language (IL) for Hardware Accelerator Generators, 2020+
...
* Scala
  * [chisel](https://github.com/freechipsproject/chisel3) ⭐ 4,791 | 🐛 510 | 🌐 Scala | 📅 2026-09-23 - Meta HDL, 2012+
  * [SpinalHDL](https://github.com/SpinalHDL/SpinalHDL) ⭐ 2,044 | 🐛 178 | 🌐 Scala | 📅 2026-09-19 - Meta HDL 2012+
...
* Veryl
  * [Veryl](https://github.com/dalance/veryl) ⭐ 1,040 | 🐛 142 | 🌐 Rust | 📅 2026-09-21 - An original HDL based on SystemVerilog / Rust syntax, and transplier to SystemVerilog
...
* [Holoso](https://github.com/Zubax/holoso) ⭐ 37 | 🐛 10 | 🌐 Python | 📅 2026-09-24 - 2026+, high-level synthesis of portable Verilog from idiomatic Python for numerical/DSP applications
...
* [act](https://github.com/asyncvlsi/act) ⭐ 130 | 🐛 2 | 🌐 C++ | 📅 2026-09-24 - asynchronous circuit/compiler tools
* [ORD](https://github.com/tub-msc/ordec) ⭐ 124 | 🐛 7 | 🌐 Python | 📅 2026-09-24 - Python-superset HDL for analog and mixed-signal IC design entry, part of the open-source ORDeC design platform
* [autopiper](https://github.com/google/autopiper) ⚠️ Archived
* [AnvilHDL](https://github.com/kisp-nus/anvil) ⭐ 36 | 🐛 27 | 🌐 OCaml | 📅 2026-09-22 - 2025+, An HDL designed to help avoid common bugs while allowing low-level control through a Rust-like type system
...
* [lgraph](https://github.com/masc-ucsc/lgraph) ⭐ 241 | 🐛 8 | 🌐 C++ | 📅 2026-09-24 - 2017-?, A Multi-Language Synthesis and Simulation IR for Hardware Design
...
* [yosys](https://github.com/YosysHQ/yosys) ⭐ 4,774 | 🐛 553 | 🌐 C++ | 📅 2026-09-24 - RTL synthesis framework
* [vtr-verilog-to-routing](https://github.com/verilog-to-routing/vtr-verilog-to-routing) ⭐ 1,270 | 🐛 130 | 🌐 C++ | 📅 2026-09-24

## Visualization and Documentation generators

* [wavedrom](https://github.com/drom/wavedrom) ⭐ 3,497 | 🐛 205 | 🌐 JavaScript | 📅 2026-08-31 - Javascript wave graph visualizer for documentations and sim.
...
* [slang](https://github.com/MikePopoloski/slang) ⭐ 1,147 | 🐛 21 | 🌐 C++ | 📅 2026-09-23 - SystemVerilog compiler and language service.
...
* [rust\_hdl](https://github.com/kraigher/rust_hdl) ⭐ 512 | 🐛 84 | 🌐 Rust | 📅 2026-09-22 - VHDL parser and language server written in Rust
* [sv-parser](https://github.com/dalance/sv-parser) ⭐ 482 | 🐛 40 | 🌐 Rust | 📅 2026-06-10 -  IEEE 1800-2017 System Verilog Parser written in Rust
* [Surelog](https://github.com/chipsalliance/Surelog) ⭐ 475 | 🐛 47 | 🌐 C++ | 📅 2026-09-24 - SystemVerilog 2017 Pre-processor, Parser, Elaborator, UHDM Compiler. Provides IEEE Design/TB C/C++ VPI and Python AST API.
...
* [cocotb](https://github.com/potentialventures/cocotb) ⭐ 2,519 | 🐛 417 | 🌐 Python | 📅 2026-09-23 - A coroutine based co-simulation library for writing VHDL and Verilog testbenches in Python
...
* [fusesoc](https://github.com/olofk/fusesoc) ⭐ 1,463 | 🐛 152 | 🌐 Python | 📅 2026-09-12 -  Package manager and a set of build tools for HDL.
...
* [bender](https://github.com/pulp-platform/bender) ⭐ 393 | 🐛 48 | 🌐 Rust | 📅 2026-09-24 -  Dependency management tool for hardware design projects.
...
* [peakrdl](https://github.com/SystemRDL/PeakRDL) ⭐ 212 | 🐛 6 | 🌐 Python | 📅 2026-09-01 - CSR toolchain to generate RTL, UVM RAL models, document(html and markdown), IPXACT, c header from SystemRDL or IPXACT.
